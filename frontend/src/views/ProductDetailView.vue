...
<style scoped>
.product-detail-page { padding: 40px 0 60px; background: transparent; min-height: 100vh; font-family: 'Quicksand', sans-serif; }
.container { max-width: 1200px; margin: 0 auto; padding: 0 20px; }

.top-nav-bar { margin-bottom: 25px; }
.back-link { display: flex; align-items: center; gap: 8px; color: #7f8c8d; text-decoration: none; font-weight: 600; font-size: 14px; transition: color 0.2s; }
...
.breadcrumb { font-size: 14px; margin-bottom: 10px; display: flex; align-items: center; gap: 8px; color: #888; }
.breadcrumb a { text-decoration: none; color: #0d6efd; font-weight: 600; }
.breadcrumb .active { color: #000; font-weight: 500; }

.product-title { font-size: 42px; font-weight: 800; color: #333; margin: 0 0 15px 0; }

.blue-text { color: #0d6efd !important; }
.price-box { margin-bottom: 15px; }
.price-box .amount { font-size: 44px; font-weight: 900; }
...
.qty-btn { background: white; border: none; padding: 0 15px; font-size: 18px; cursor: pointer; transition: 0.2s; height: 100%; }
...
.rel-info h4 { font-size: 16px; font-weight: 600; color: #333; margin: 0 0 5px; }
